...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/platform')) {
            ...
            if (0 === strpos($pathinfo, '/platform/advert/test')) {
                // oc_platform_test
                if ($pathinfo === '/platform/advert/test') {
                    return array (  '_controller' => 'OC\\PlatformBundle\\Controller\\AdvertController::testAction',  '_route' => 'oc_platform_test',);
                }

                // oc_platform_test_2
                if ($pathinfo === '/platform/advert/test_2') {
                    return array (  '_controller' => 'OC\\PlatformBundle\\Controller\\AdvertController::test_2Action',  '_route' => 'oc_platform_test_2',);
                }
